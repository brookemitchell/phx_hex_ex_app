defmodule PhxApp.ShoppingCart do
  @moduledoc """
  ...
  alias PhxApp.Repo
  alias PhxApp.ShoppingCart.Cart
  alias PhxApp.ShoppingCart.CartItem
  ...
  defp reload_cart(cart), do: get_cart_by_user_uuid(cart.user_uuid)
