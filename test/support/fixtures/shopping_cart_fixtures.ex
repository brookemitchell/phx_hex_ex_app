defmodule PhxApp.ShoppingCartFixtures do
  @moduledoc """
  This module defines test helpers for creating
  entities via the `PhxApp.ShoppingCart` context.
  """
  ...
  def cart_fixture(attrs \\ %{}) do
    {:ok, cart} =
      ...
      |> PhxApp.ShoppingCart.create_cart()
  ...
  def cart_item_fixture(attrs \\ %{}) do
    {:ok, cart_item} =
      ...
      |> PhxApp.ShoppingCart.create_cart_item()
